    ...
    render(){
        ...
        return(
                      ...
                      <Card>
                        ...
                        <Right>
                            <Icon name="dots-three-vertical" type ="Entypo" style ={{color : 'black'}}/>
                        </Right>

                        </CardItem>
                        <CardItem cardBody>
                          <Image source={images[this.props.imageSource]} style={{height: 300, width: undefined, flex: 1}}/>
                        </CardItem>

                        <CardItem style={{ height: 45 }}> 
                            <Left  style = {{alignSelf:"center"}}>
                            <Button transparent>
                            <Icon name="heart" type="Feather" style={{ color: 'black' , fontSize:25}} />
                        </Button>
                        <Button transparent>
                            <Icon name="message-circle" type="Feather" style={{ color: 'black', fontSize:25 }} />
                        </Button>
                        <Button transparent>
                            <Icon name="send" type="Feather" style={{ color: 'black', fontSize:25 }} />
                        </Button>
                            </Left>
